...
```{r}
#Crab size data
crab_size <- read.csv("https://raw.githubusercontent.com/catesbecca/cates_crab_manuscript/main/Data%26Scripts/Size_Distribution/crabsize_otterdensity_data.csv", header = TRUE, stringsAsFactors = FALSE, na.strings=c("","NA"))

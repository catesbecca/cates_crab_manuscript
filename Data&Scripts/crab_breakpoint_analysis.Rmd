...
#Read in crab data
```{r}
crab_cpue <- read.csv("crab_CPUE.csv", header = TRUE, stringsAsFactors = FALSE, na.strings=c("","NA"))

crab_bpue <- read.csv("crab_BPUE.csv", header = TRUE, stringsAsFactors = FALSE, na.strings=c("","NA"))
```

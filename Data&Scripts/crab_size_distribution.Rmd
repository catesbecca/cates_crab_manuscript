...
#Read in data
```{r}
crab_size<- read.csv("clean_crab_otter_size_data_all_years.csv", header = TRUE, stringsAsFactors = FALSE, na.strings=c("","NA")) #eventually source from KNB

#otter density across all sites
otter <- read.csv("D:/Documents/UAF/Data/Data 2019/Sea Otter/Otter_density_site_allyears.csv", header = TRUE, stringsAsFactors = FALSE, na.strings=c("","NA"))
